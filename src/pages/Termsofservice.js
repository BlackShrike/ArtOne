...
const TermsOfService = () => {
  ...
  return (
    <div className={styles.tosContainer}>
      <div className={styles.tosSidebar}>
        <ul>
          <li
            className={
              activeSection === "terms-of-service" ? styles.active : ""
            }
          ...
          <li
            className={activeSection === "privacy-policy" ? styles.active : ""}
      ...
      <div className={styles.tosContent}>
        {activeSection === "terms-of-service" && (
          <div id="terms-of-service">
            <h1 className={styles.tosHeader}>이용약관</h1>
            <div className={styles.tosSection}>
              <h2>제1조 목적</h2>
              <p>
                본 이용약관은 “Contemporary K”(이하 “Contemporary K”)의 서비스의
              ...
              <ul>
                <li>
                  ① 회원 : Contemporary K의 약관에 동의하고 개인정보를 제공하여
                  회원등록을 한 자로서, 사이트와의 이용계약을 체결하고 사이트를
                  이용하는 이용자를 말합니다.
                </li>
                <li>
                  ② 이용계약 : Contemporary K 이용과 관련하여 사이트와 회원간에
                  체결 하는 계약을 말합니다.
                </li>
                <li>
                  ③ 회원 아이디(이하 “ID”) : Contemporary K 회원의 식별과 회원의
                  서비스 이용을 위하여 회원별로 부여하는 고유한 문자와 숫자의
                  조합을 말합니다.
                </li>
                <li>
                  ④ 비밀번호 : Contemporary K 회원이 부여받은 ID와 일치된
                  회원임을 확인하고 회원의 권익 보호를 위하여 회원이 선정한
                  문자와 숫자의 조합을 말합니다.
                </li>
                <li>
                  ⑤ 운영자 : Contemporary K 서비스에 홈페이지를 개설하여
                  운영하는 운영자를 말합니다.
                </li>
                <li>
                  ⑥ 해지 : Contemporary K 회원이 이용계약을 해약하는 것을
                  말합니다.
                </li>
              </ul>
              <h2>제3조 약관 외 준칙</h2>
              ...
              <p>
                ...
                개인정보처리방침에 정한 바에 따릅니다. 단, 회원의 귀책 사유로
                인해 노출된 정보에 대해 운영자는 일체의 책임을 지지 않습니다.
              </p>
              <p>
              ...
              <p>
                ...
                게시물 등록자 간에 소송, 합의 기타 이에 준하는 관련 기관의 결정
                등이 이루어져 사이트에 접수된 경우 이에 따릅니다.
              </p>
              <h2>제13조 게시물의 보관</h2>
              <p>
                사이트 운영자가 불가피한 사정으로 본 사이트를 중단하게 될 경우,
                회원에게 사전 공지를 하고 게시물의 이전이 쉽도록 모든 조치를
                하기 위해 노력합니다.
              </p>
              ...
              <p>
                ⑤ 운영자는 회원 상호 간 또는 회원과 제3자 상호 간, 기타 회원의
        ...
        {activeSection === "privacy-policy" && (
          <div id="privacy-policy">
            <h1 className={styles.tosHeader}>개인정보 처리방침</h1>
            <div className={styles.tosSection}>
              <p>
                회사명(이하 'Contemporary K'라 한다)는 개인정보 보호법 제30조에
              ...
              <ul>
                <li>
                  ...
                  본인확인제 시행에 따른 본인확인, 서비스 부정 이용 방지, 각종
                  고지 통지, 고충 처리 등을 목적으로 개인정보를 처리합니다.
                </li>
                <li>
                  2. 재화 또는 서비스 제공: 물품 배송, 서비스 제공, 계약서 및
                  청구서 발송, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 연령인증,
                  요금 결제 및 정산, 채권추심 등을 목적으로 개인정보를
                  처리합니다.
                </li>
                <li>
              ...
              <p>
                ...
                <ul>
                  <li>
                    ...
                    <ul>
                      <li>
                        필수항목 : {">"}예) 성명, 생년월일, 아이디, 비밀번호,
                        주소, 전화번호, 성별, 이메일주소, 아이핀번호{">"}
                      </li>
                      <li>
                        선택항목 : {">"}예) 결혼 여부, 관심 분야{">"}
                      </li>
              ...
              <p>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    Format) 등의 방법을 이용하여 파기하며, 종이 문서에
              ...
              <p>이 개인정보 처리방침은 2024. 03. 06부터 적용됩니다.</p>
            </div>
          </div>
        )}
      </div>
